...
const ProjectDetail = () => {
  ...
  return (
    <div className="container-fluid bg-white p-0 overflow-hidden">
      ...
      <div className="project-detail-hero position-relative d-flex align-items-center justify-content-center" style={{ backgroundImage: `linear-gradient(rgba(5, 29, 71, 0.9), rgba(5, 29, 71, 0.9)), url(${getImageUrl(project.image)})` }}>
